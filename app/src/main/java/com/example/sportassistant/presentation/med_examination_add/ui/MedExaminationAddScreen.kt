package com.example.sportassistant.presentation.med_examination_add.ui
        ...
        Card(
            ...
            Box(
                ...
                val date = datePickerState.selectedDateMillis?.let {
                    ...
                    medExaminationAddViewModel.setDate(date)
                ...
                DatePickerDialog(
                    ...
                    dismissButton = {
                        TextButton(onClick = {
                            ...
                            medExaminationAddViewModel.setDate(LocalDate.now())
                        }) {
            ...
            StyledCardTextField(
                ...
                onValueChange = {
                    medExaminationAddViewModel.setInstitution(it)
                },
                maxLines = 3,
                modifier = Modifier.padding(
                    start = 15.dp,
            ...
            StyledCardTextField(
                ...
                onValueChange = {
                    medExaminationAddViewModel.setMethods(it)
                },
                maxLines = 3,
                modifier = Modifier.padding(
                    start = 15.dp,
            ...
            StyledCardTextField(
                ...
                onValueChange = {
                    medExaminationAddViewModel.setRecommendations(it)
                },
                maxLines = 5,
                modifier = Modifier.padding(
                    start = 15.dp,
