...
import com.example.sportassistant.presentation.ofp_result_add.ui.getCategoryText
        ...
        when (ofpInfoResponse) {
            ...
            is ApiResponse.Success -> {
                LaunchedEffect(Unit) {
                    ...
                    ofpResultsInfoViewModel.setResult(ofpData.result.toString())
...
private fun isModified(state: OFPResultModelUiState, prevState: OFPResult): Boolean {
    return (state.categoryId != prevState.categoryId
            ...
            || state.result != prevState.result.toString())
}